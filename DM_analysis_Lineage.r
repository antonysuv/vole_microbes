...
Nsample=nrow(y)
Notu=ncol(y)
regions=c(ifelse(meta.n$Lineage=="N",1,0),ifelse(meta.cs$Lineage=="N",2,ifelse(meta.cs$Lineage=="S",3,4)),ifelse(meta.s$Lineage=="S",5,0))
...
model
{
    ...
    sigma_distance=c(0.2995745,1.2992233,1.2992233,1.2992233,0.3495740)
    err ~ dnorm(0,3)
}
" 
...
save(fit, file = "MCMC_lineage.RData")
